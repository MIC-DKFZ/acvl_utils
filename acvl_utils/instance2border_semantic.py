...
import os
from helper import utils, global_mp_pool
import argparse
...
if __name__ == '__main__':
    ...
    if input.endswith(".nii.gz"):
        single_instance2border_semantic(input, output, parallel=args.parallel, border_thickness_in_pixel=args.border_thickness)
    else:
        all_instance2border_semantic(input, output, parallel=args.parallel, border_thickness_in_pixel=args.border_thickness)
